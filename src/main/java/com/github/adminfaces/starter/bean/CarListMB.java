...
@Named
@ViewScoped
public class CarListMB extends LazyDataModel<Car> {
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
			 ...
			 */
			private static final long serialVersionUID = 1L;	
			public List<Car> load(int first, int pageSize, String sortField, Map<String, Object> filters) {
                com.github.adminfaces.starter.infra.model.SortOrder order = null;
                if (sortField != null) {
                    order = sortField.equals(SortOrder.ASCENDING) ? com.github.adminfaces.starter.infra.model.SortOrder.ASCENDING
                            : sortField.equals(SortOrder.DESCENDING) ? com.github.adminfaces.starter.infra.model.SortOrder.DESCENDING
